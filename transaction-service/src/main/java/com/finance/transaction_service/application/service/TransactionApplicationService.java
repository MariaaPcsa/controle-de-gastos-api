...
import com.finance.transaction_service.domain.usecase.*;
...
public class TransactionApplicationService {
    ...
    // CREATE
    public Transaction create(Long userId, String description, BigDecimal amount, String currency, TransactionType type) {
        // Validação básica
        ...
        // Converte se não for BRL
        BigDecimal convertedAmount = "BRL".equalsIgnoreCase(currency) ? amount
                : exchangeRateClient.convert(amount, currency, "BRL");

        // Cria transação
        Transaction transaction = Transaction.create(userId, description, convertedAmount, amount, currency, type);
    ...
    public Transaction update(Long id,
        ...
        return updateUseCase.execute(id, description, convertedAmount, amount, currency, type);
    }
