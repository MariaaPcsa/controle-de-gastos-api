...
class TransactionApplicationServiceTest {
    ...
    void should_update_transaction_successfully() {
        ...
        Transaction updated = Transaction.create(
                1L,
                description,
                amount,
                originalAmount,
        ...
        Transaction result = service.update(
                transactionId,
                description,
                amount,
                originalAmount,
    ...
    void should_list_transactions_successfully() {
        ...
        when(listUseCase.execute(userId))
